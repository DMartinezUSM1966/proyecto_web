        ...
        <div class="container-fluid mt-2">
            <div class="row">
                @foreach ($vehiculos as $vehiculo) 
                    @if ($vehiculo->estado_vehiculo == 1 && $vehiculo->marcaVehiculo == 5)
                    <div class="col-md-3">
                        <div class="card text-white">
                            <img src="{{$vehiculo->url_imagen}}" class="card-img-top" alt="Imagen de {{ $vehiculo->marcaVehiculo }}">
        ...
        <div class="modal fade" id="modalArrendar{{$vehiculo->id}}" tabindex="-1" aria-labelledby="modalArrendarLabel{{$vehiculo->id}}" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content bg-dark text-white">
                    <form action="{{ route('arriendos.crear', $vehiculo->id) }}" method="POST" id="formArriendo{{$vehiculo->id}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="modal-body" id="modalArriendo">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <label for="imagen_arriendo{{$vehiculo->id}}" class="form-label">Subir imagen del vehículo</label>
                                        <input type="text" class="form-control @error('imagen_arriendo') is-invalid @enderror" id="imagen_arriendo{{$vehiculo->id}}" name="imagen_arriendo"  required>
                                        @error('imagen_arriendo')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        @enderror
